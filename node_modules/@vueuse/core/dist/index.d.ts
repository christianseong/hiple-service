 ...
 * @param options
 */
declare function onClickOutside<E extends keyof OnClickOutsideEvents = 'pointerdown'>(target: MaybeElementRef, handler: (evt: OnClickOutsideEvents[E]) => void, options?: OnClickOutsideOptions<E>): _vueuse_shared.Fn | undefined;
...
interface UseFetchReturnBase<T> {
     ...
     */
    onFetchResponse: (fn: (response: Response) => void) => {
        off: () => void;
    };
    /**
     * Fires after a fetch request error
     */
    onFetchError: (fn: (error: any) => void) => {
        off: () => void;
    };
}
...
declare function useMediaControls(target: MaybeRef<HTMLMediaElement | null | undefined>, options?: UseMediaControlsOptions): {
    ...
    onSourceError: (fn: (param: Event) => void) => {
        off: () => void;
    };
};
